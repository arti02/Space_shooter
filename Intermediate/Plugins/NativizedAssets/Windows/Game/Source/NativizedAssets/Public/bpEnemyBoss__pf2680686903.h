...
#include "bpEnemyBoss__pf2680686903.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Blueprints/Enemies/bpEnemyBoss.bpEnemyBoss_C", OverrideNativeName="bpEnemyBoss_C"))
class AbpEnemyBoss_C__pf2680686903 : public ABpEnemyBase_C__pf2680686903
{
public:
	GENERATED_BODY()
	...
	AbpEnemyBoss_C__pf2680686903(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	UFUNCTION(meta=(OverrideNativeName="ExecuteUbergraph_bpEnemyBoss_0"))
	void bpf__ExecuteUbergraph_bpEnemyBoss__pf_0(int32 bpp__EntryPoint__pf);
