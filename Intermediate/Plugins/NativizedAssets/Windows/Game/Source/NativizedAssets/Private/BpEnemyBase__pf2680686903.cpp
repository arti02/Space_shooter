...
#include "../Plugins/Cameras/GameplayCameras/Source/GameplayCameras/Public/DefaultCameraShakeBase.h"
#include "bpPickUpCoin__pf407142385.h"
#include "bpPickUpRocket__pf407142385.h"
#include "bpPoweUp__pf407142385.h"
...
ABpEnemyBase_C__pf2680686903::ABpEnemyBase_C__pf2680686903(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__EnemyMesh__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("EnemyMesh"));
	RootComponent = bpv__EnemyMesh__pf;
	bpv__EnemyMesh__pf->CreationMethod = EComponentCreationMethod::Native;
	auto& __Local__0 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionChannel> >(&(bpv__EnemyMesh__pf->BodyInstance), FBodyInstance::__PPO__ObjectType() )));
	__Local__0 = ECollisionChannel::ECC_GameTraceChannel1;
	auto& __Local__1 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionEnabled::Type> >(&(bpv__EnemyMesh__pf->BodyInstance), FBodyInstance::__PPO__CollisionEnabled() )));
	__Local__1 = ECollisionEnabled::Type::QueryOnly;
	auto& __Local__2 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__EnemyMesh__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__6.Channel = FName(TEXT("EnemyProjectile"));
	...
	bpv__EnemyMesh__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	...
	(((FBoolProperty*)__Local__10)->SetPropertyValue_InContainer((bpv__EnemyMesh__pf), true, 0));
	bpv__SpawnAnimation_Speed_F9D387B84A7CDE5662812BA1B9DEE299__pf = 0.000000f;
	bpv__SpawnAnimation__Direction_F9D387B84A7CDE5662812BA1B9DEE299__pf = ETimelineDirection::Type::Forward;
	bpv__SpawnAnimation__pf = nullptr;
	bpv__Bp_gameMod__pf = nullptr;
	bpv__Health__pf = 0.000000f;
	bpv__MaxHealth__pf = 0.000000f;
	bpv__RandomDirection__pf = 0.000000f;
	bpv__MoveSpeed__pf = 0.000000f;
	bpv__FireRate__pf = 0.000000f;
	bpv__SweepIn__pf = 0.000000f;
	bpv__DropRate__pf = 0.000000f;
	bpv__bMove_direction__pf = false;
	bpv__BMove_enabled__pf = 0.000000f;
	bpv__SpawnLocation__pf = FVector(0.000000, 0.000000, 0.000000);
	bpv__Move_enabled__pf = false;
	bpv__PickUps__pf = TArray<UClass*> ();
	bpv__PickUps__pf.Reserve(3);
	bpv__PickUps__pf.Add(AbpPickUpCoin_C__pf407142385::StaticClass());
	bpv__PickUps__pf.Add(AbpPickUpRocket_C__pf407142385::StaticClass());
	bpv__PickUps__pf.Add(AbpPoweUp_C__pf407142385::StaticClass());
...
void ABpEnemyBase_C__pf2680686903::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
	if(bpv__EnemyMesh__pf)
	{
		bpv__EnemyMesh__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void ABpEnemyBase_C__pf2680686903::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(AbpPickUpCoin_C__pf407142385::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(AbpPickUpRocket_C__pf407142385::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(AbpPoweUp_C__pf407142385::StaticClass());
	...
	auto __Local__14 = NewObject<UTimelineTemplate>(InDynamicClass, UTimelineTemplate::StaticClass(), TEXT("SpawnAnimation_Template"), (EObjectFlags)0x00280008);
	InDynamicClass->Timelines.Add(__Local__14);
	...
	__Local__14->TimelineLength = 1.000000f;
	__Local__14->FloatTracks = TArray<FTTFloatTrack> ();
	__Local__14->FloatTracks.AddUninitialized(1);
	FTTFloatTrack::StaticStruct()->InitializeStruct(__Local__14->FloatTracks.GetData(), 1);
	auto& __Local__17 = __Local__14->FloatTracks[0];
	auto __Local__18 = NewObject<UCurveFloat>(InDynamicClass, UCurveFloat::StaticClass(), TEXT("CurveFloat_0"), (EObjectFlags)0x00280009);
	...
	__Local__19.TangentMode = ERichCurveTangentMode::RCTM_User;
	__Local__19.ArriveTangent = 2.269385f;
	__Local__19.LeaveTangent = 2.269385f;
	...
	auto& __Local__21 = (*(AccessPrivateProperty<FName >(&(__Local__17), FTTPropertyTrack::__PPO__PropertyName() )));
	__Local__21 = FName(TEXT("SpawnAnimation_Speed_F9D387B84A7CDE5662812BA1B9DEE299"));
	auto& __Local__22 = (*(AccessPrivateProperty<FName >(&(__Local__17), FTTTrackBase::__PPO__TrackName() )));
	__Local__22 = FName(TEXT("Speed"));
	__Local__14->TimelineGuid = FGuid(0xF9D387B8, 0x4A7CDE56, 0x62812BA1, 0xB9DEE299);
	auto& __Local__23 = (*(AccessPrivateProperty<FName >((__Local__14), UTimelineTemplate::__PPO__VariableName() )));
	__Local__23 = FName(TEXT("SpawnAnimation"));
	auto& __Local__24 = (*(AccessPrivateProperty<FName >((__Local__14), UTimelineTemplate::__PPO__DirectionPropertyName() )));
	__Local__24 = FName(TEXT("SpawnAnimation__Direction_F9D387B84A7CDE5662812BA1B9DEE299"));
	auto& __Local__25 = (*(AccessPrivateProperty<FName >((__Local__14), UTimelineTemplate::__PPO__UpdateFunctionName() )));
	__Local__25 = FName(TEXT("SpawnAnimation__UpdateFunc"));
	auto& __Local__26 = (*(AccessPrivateProperty<FName >((__Local__14), UTimelineTemplate::__PPO__FinishedFunctionName() )));
	__Local__26 = FName(TEXT("SpawnAnimation__FinishedFunc"));
}
PRAGMA_ENABLE_OPTIMIZATION
void ABpEnemyBase_C__pf2680686903::bpf__ExecuteUbergraph_BpEnemyBase__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 1:
			{
				UGameplayStatics::PlaySound2D(this, CastChecked<USoundBase>(CastChecked<UDynamicClass>(ABpEnemyBase_C__pf2680686903::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed), 1.000000, 1.000000, 0.000000, ((USoundConcurrency*)nullptr), ((AActor*)nullptr), true);
			}
		case 2:
			{
				K2_DestroyActor();
		...
		case 11:
			{
				...
				bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf = UGameplayStatics::FinishSpawningActor(b0l__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, b0l__CallFunc_GetTransform_ReturnValue__pf);
			}
		case 12:
			{
				bpfv__CallFunc_K2_GetActorLocation_ReturnValue_2__pf = AActor::K2_GetActorLocation();
				bpfv__CallFunc_SpawnEmitterAtLocation_ReturnValue__pf = UGameplayStatics::SpawnEmitterAtLocation(this, CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(ABpEnemyBase_C__pf2680686903::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed), bpfv__CallFunc_K2_GetActorLocation_ReturnValue_2__pf, FRotator(0.000000,0.000000,0.000000), FVector(1.000000,1.000000,1.000000), true, EPSCPoolMethod::None, true);
			}
		case 13:
			{
				if(::IsValid(bpv__Bp_gameMod__pf))
				{
					bpv__Bp_gameMod__pf->bpf__CallCameShake__pf(CastChecked<UClass>(CastChecked<UDynamicClass>(ABpEnemyBase_C__pf2680686903::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
				}
				__CurrentState = 1;
				break;
			}
		...
		case 21:
			{
				b0l__K2Node_DynamicCast_AsBp_Enemy_Base__pf = Cast<ABpEnemyBase_C__pf2680686903>(b0l__K2Node_Event_Other__pf);
		...
		case 22:
			{
				bpfv__CallFunc_Not_PreBool_ReturnValue__pf = UKismetMathLibrary::Not_PreBool(bpv__bMove_direction__pf);
				bpv__bMove_direction__pf = bpfv__CallFunc_Not_PreBool_ReturnValue__pf;
			}
		case 23:
			{
				b0l__K2Node_DynamicCast_AsBp_Player__pf = Cast<AbpPlayer_C__pf1380491225>(b0l__K2Node_Event_Other__pf);
		...
		case 24:
			{
				bpfv__CallFunc_ApplyDamage_ReturnValue__pf = UGameplayStatics::ApplyDamage(b0l__K2Node_DynamicCast_AsBp_Player__pf, 50.000000, ((AController*)nullptr), ((AActor*)nullptr), ((UClass*)nullptr));
			}
		case 25:
			{
				if(::IsValid(bpv__Bp_gameMod__pf))
				{
					bpv__Bp_gameMod__pf->bpf__AddScore__pf();
				}
			}
		case 26:
			{
				bpfv__CallFunc_RandomFloatInRange_ReturnValue_2__pf = UKismetMathLibrary::RandomFloatInRange(0.000000, 1.000000);
				bpfv__CallFunc_LessEqual_FloatFloat_ReturnValue_1__pf = UKismetMathLibrary::LessEqual_FloatFloat(bpfv__CallFunc_RandomFloatInRange_ReturnValue_2__pf, bpv__DropRate__pf);
		...
		case 27:
			{
				b0l__CallFunc_GetTransform_ReturnValue__pf = AActor::GetTransform();
				bpfv__CallFunc_Array_LastIndex_ReturnValue__pf = FCustomThunkTemplates::Array_LastIndex(bpv__PickUps__pf);
				...
				FCustomThunkTemplates::Array_Get(bpv__PickUps__pf, bpfv__CallFunc_RandomIntegerInRange_ReturnValue__pf, /*out*/ b0l__CallFunc_Array_Get_Item__pf);
				b0l__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, b0l__CallFunc_Array_Get_Item__pf, b0l__CallFunc_GetTransform_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::Undefined, ((AActor*)nullptr));
				__CurrentState = 11;
				break;
			}
		case 28:
		...
		case 29:
			{
				...
				bpfv__CallFunc_FClamp_ReturnValue__pf = UKismetMathLibrary::FClamp(bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf, 0.000000, bpv__MaxHealth__pf);
		...
		case 31:
			{
				int32  __Local__27 = 0;
				bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf = UKismetMathLibrary::Subtract_IntInt(((::IsValid(bpv__Bp_gameMod__pf)) ? (bpv__Bp_gameMod__pf->bpv__LiveEnemies__pf) : (__Local__27)), 1);
				if(::IsValid(bpv__Bp_gameMod__pf))
				{
					bpv__Bp_gameMod__pf->bpv__LiveEnemies__pf = bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf;
				}
				__CurrentState = 25;
				break;
			}
...
void ABpEnemyBase_C__pf2680686903::bpf__ExecuteUbergraph_BpEnemyBase__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	bpfv__CallFunc_MakeVector_ReturnValue__pf = UKismetMathLibrary::MakeVector(0.000000, bpv__SweepIn__pf, 0.000000);
	bpfv__CallFunc_Subtract_VectorVector_ReturnValue__pf = UKismetMathLibrary::Subtract_VectorVector(bpv__SpawnLocation__pf, bpfv__CallFunc_MakeVector_ReturnValue__pf);
	bpfv__CallFunc_VLerp_ReturnValue__pf = UKismetMathLibrary::VLerp(bpv__SpawnLocation__pf, bpfv__CallFunc_Subtract_VectorVector_ReturnValue__pf, 0.000000);
	bpfv__CallFunc_K2_SetActorLocation_ReturnValue__pf = AActor::K2_SetActorLocation(bpfv__CallFunc_VLerp_ReturnValue__pf, false, /*out*/ b0l__CallFunc_K2_SetActorLocation_SweepHitResult__pf, false);
	return; // KCST_GotoReturn
}
void ABpEnemyBase_C__pf2680686903::bpf__ExecuteUbergraph_BpEnemyBase__pf_2(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 32);
	// optimized KCST_UnconditionalGoto
	bpv__Move_enabled__pf = true;
	return; // KCST_GotoReturn
}
void ABpEnemyBase_C__pf2680686903::bpf__ExecuteUbergraph_BpEnemyBase__pf_3(int32 bpp__EntryPoint__pf)
{
	...
	// optimized KCST_UnconditionalGoto
	if (!bpv__Move_enabled__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	bpfv__CallFunc_K2_GetActorLocation_ReturnValue_1__pf = AActor::K2_GetActorLocation();
	bpfv__CallFunc_SelectFloat_ReturnValue__pf = UKismetMathLibrary::SelectFloat(1.000000, -1.000000, bpv__bMove_direction__pf);
	bpfv__CallFunc_Multiply_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Multiply_FloatFloat(bpv__MoveSpeed__pf, bpfv__CallFunc_SelectFloat_ReturnValue__pf);
	bpfv__CallFunc_MakeVector_ReturnValue_1__pf = UKismetMathLibrary::MakeVector(0.000000, 0.000000, bpfv__CallFunc_Multiply_FloatFloat_ReturnValue__pf);
	bpfv__CallFunc_GreaterGreater_VectorRotator_ReturnValue__pf = UKismetMathLibrary::GreaterGreater_VectorRotator(bpfv__CallFunc_MakeVector_ReturnValue_1__pf, FRotator(0.000000,0.000000,0.000000));
	bpfv__CallFunc_Multiply_VectorFloat_ReturnValue__pf = UKismetMathLibrary::Multiply_VectorFloat(bpfv__CallFunc_GreaterGreater_VectorRotator_ReturnValue__pf, b0l__K2Node_Event_DeltaSeconds__pf);
	bpfv__CallFunc_Add_VectorVector_ReturnValue__pf = UKismetMathLibrary::Add_VectorVector(bpfv__CallFunc_K2_GetActorLocation_ReturnValue_1__pf, bpfv__CallFunc_Multiply_VectorFloat_ReturnValue__pf);
	bpfv__CallFunc_K2_SetActorLocation_ReturnValue_1__pf = AActor::K2_SetActorLocation(bpfv__CallFunc_Add_VectorVector_ReturnValue__pf, true, /*out*/ b0l__CallFunc_K2_SetActorLocation_SweepHitResult_1__pf, false);
	return; // KCST_GotoReturn
}
void ABpEnemyBase_C__pf2680686903::bpf__ExecuteUbergraph_BpEnemyBase__pf_4(int32 bpp__EntryPoint__pf)
{
	...
	bpv__Bp_gameMod__pf = b0l__K2Node_DynamicCast_AsBp_Game_Mod__pf;
	int32  __Local__28 = 0;
	bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(((::IsValid(bpv__Bp_gameMod__pf)) ? (bpv__Bp_gameMod__pf->bpv__LiveEnemies__pf) : (__Local__28)), 1);
	if(::IsValid(bpv__Bp_gameMod__pf))
	{
		bpv__Bp_gameMod__pf->bpv__LiveEnemies__pf = bpfv__CallFunc_Add_IntInt_ReturnValue__pf;
	}
	bpfv__CallFunc_RandomBool_ReturnValue__pf = UKismetMathLibrary::RandomBool();
	bpv__bMove_direction__pf = bpfv__CallFunc_RandomBool_ReturnValue__pf;
	bpfv__CallFunc_RandomFloatInRange_ReturnValue__pf = UKismetMathLibrary::RandomFloatInRange(800.000000, 1400.000000);
	bpv__MoveSpeed__pf = bpfv__CallFunc_RandomFloatInRange_ReturnValue__pf;
	bpfv__CallFunc_RandomFloatInRange_ReturnValue_1__pf = UKismetMathLibrary::RandomFloatInRange(1200.000000, 1700.000000);
	bpv__SweepIn__pf = bpfv__CallFunc_RandomFloatInRange_ReturnValue_1__pf;
...
void ABpEnemyBase_C__pf2680686903::bpf__ReceiveAnyDamage__pf(float bpp__Damage__pf, const UDamageType* bpp__DamageType__pf__const, AController* bpp__InstigatedBy__pf, AActor* bpp__DamageCauser__pf)
{
	typedef UDamageType*  T__Local__29;
	T__Local__29& bpp__DamageType__pf = *const_cast<T__Local__29 *>(&bpp__DamageType__pf__const);
	...
	bpf__ExecuteUbergraph_BpEnemyBase__pf_0(28);
}
void ABpEnemyBase_C__pf2680686903::bpf__ReceiveHit__pf(UPrimitiveComponent* bpp__MyComp__pf, AActor* bpp__Other__pf, UPrimitiveComponent* bpp__OtherComp__pf, bool bpp__bSelfMoved__pf, FVector bpp__HitLocation__pf, FVector bpp__HitNormal__pf, FVector bpp__NormalImpulse__pf, FHitResult const& bpp__Hit__pf__const)
{
	typedef FHitResult  T__Local__30;
	T__Local__30& bpp__Hit__pf = *const_cast<T__Local__30 *>(&bpp__Hit__pf__const);
	...
	bpf__ExecuteUbergraph_BpEnemyBase__pf_0(20);
}
void ABpEnemyBase_C__pf2680686903::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_BpEnemyBase__pf_4(19);
}
void ABpEnemyBase_C__pf2680686903::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_BpEnemyBase__pf_3(15);
}
void ABpEnemyBase_C__pf2680686903::bpf__SpawnAnimation__UpdateFunc__pf()
{
	bpf__ExecuteUbergraph_BpEnemyBase__pf_1(33);
}
void ABpEnemyBase_C__pf2680686903::bpf__SpawnAnimation__FinishedFunc__pf()
{
	bpf__ExecuteUbergraph_BpEnemyBase__pf_2(32);
}
void ABpEnemyBase_C__pf2680686903::bpf__UserConstructionScript__pf()
{
	bpv__Health__pf = bpv__MaxHealth__pf;
}
PRAGMA_DISABLE_OPTIMIZATION
void ABpEnemyBase_C__pf2680686903::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABpEnemyBase_C__pf2680686903::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{92, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Blueprints/PickUps/bpPickUpCoin.bpPickUpCoin_C 
		{93, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Blueprints/PickUps/bpPickUpRocket.bpPickUpRocket_C 
		{94, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Blueprints/PickUps/bpPoweUp.bpPoweUp_C 
	};
	for(const FCompactBlueprintDependencyData& CompactData : LocCompactBlueprintDependencyData)
	{
		AssetsToLoad.Add(FBlueprintDependencyData(F__NativeDependencies::Get(CompactData.ObjectRefIndex), CompactData));
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABpEnemyBase_C__pf2680686903
{
	FRegisterHelper__ABpEnemyBase_C__pf2680686903()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/Enemies/BpEnemyBase"), &ABpEnemyBase_C__pf2680686903::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABpEnemyBase_C__pf2680686903 Instance;
};
FRegisterHelper__ABpEnemyBase_C__pf2680686903 FRegisterHelper__ABpEnemyBase_C__pf2680686903::Instance;
