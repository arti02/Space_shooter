...
AbpPickUpCoin_C__pf407142385::AbpPickUpCoin_C__pf407142385(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	auto& __Local__0 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__PickUpMesh__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__0 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AbpPickUpCoin_C__pf407142385::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
...
void AbpPickUpCoin_C__pf407142385::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void AbpPickUpCoin_C__pf407142385::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__8.FunctionNameToBind = FName(TEXT("BndEvt__bpPickUpCoin_PickUpMesh_K2Node_ComponentBoundEvent_2_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AbpPickUpCoin_C__pf407142385::bpf__ExecuteUbergraph_bpPickUpCoin__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	b1l__K2Node_DynamicCast_bSuccess_1__pf = (b1l__K2Node_DynamicCast_AsBp_Player__pf != nullptr);;
	...
	b1l__K2Node_DynamicCast_AsBp_Game_Mod__pf = Cast<AbpGameMod_C__pf1380491225>(bpfv__CallFunc_GetGameMode_ReturnValue__pf);
	b1l__K2Node_DynamicCast_bSuccess__pf = (b1l__K2Node_DynamicCast_AsBp_Game_Mod__pf != nullptr);;
	if (!b1l__K2Node_DynamicCast_bSuccess__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	if(::IsValid(b1l__K2Node_DynamicCast_AsBp_Game_Mod__pf))
	{
		b1l__K2Node_DynamicCast_AsBp_Game_Mod__pf->bpf__AddCoin__pf();
	}
	// optimized KCST_UnconditionalGoto
	K2_DestroyActor();
	return; // KCST_GotoReturn
}
void AbpPickUpCoin_C__pf407142385::bpf__BndEvt__bpPickUpCoin_PickUpMesh_K2Node_ComponentBoundEvent_2_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_bpPickUpCoin__pf_0(2);
}
PRAGMA_DISABLE_OPTIMIZATION
void AbpPickUpCoin_C__pf407142385::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AbpPickUpCoin_C__pf407142385::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AbpPickUpCoin_C__pf407142385
{
	FRegisterHelper__AbpPickUpCoin_C__pf407142385()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/PickUps/bpPickUpCoin"), &AbpPickUpCoin_C__pf407142385::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AbpPickUpCoin_C__pf407142385 Instance;
};
FRegisterHelper__AbpPickUpCoin_C__pf407142385 FRegisterHelper__AbpPickUpCoin_C__pf407142385::Instance;
