...
#include "Cube4_Blueprint__pf2132744816.h"
...
ACube4_Blueprint_C__pf2132744816::ACube4_Blueprint_C__pf2132744816(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	if(__Local__0)
	{
		...
		__Local__1 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ACube4_Blueprint_C__pf2132744816::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
		...
		__Local__0->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ACube4_Blueprint_C__pf2132744816::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
		...
		__Local__0->bFillCollisionUnderneathForNavmesh = true;
		...
		__Local__4 = FVector(5.000000, 100.000000, 1.000000);
...
void ACube4_Blueprint_C__pf2132744816::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void ACube4_Blueprint_C__pf2132744816::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__10 = NewObject<UComponentDelegateBinding>(InDynamicClass, UComponentDelegateBinding::StaticClass(), TEXT("ComponentDelegateBinding_1"), (EObjectFlags)0x00000000);
	...
	(((FBoolProperty*)__Local__11)->SetPropertyValue_InContainer((__Local__9), false, 0));
	__Local__10->ComponentDelegateBindings = TArray<FBlueprintComponentDelegateBinding> ();
	__Local__10->ComponentDelegateBindings.AddUninitialized(1);
	FBlueprintComponentDelegateBinding::StaticStruct()->InitializeStruct(__Local__10->ComponentDelegateBindings.GetData(), 1);
	auto& __Local__13 = __Local__10->ComponentDelegateBindings[0];
	__Local__13.ComponentPropertyName = FName(TEXT("StaticMeshComponent"));
	__Local__13.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__13.FunctionNameToBind = FName(TEXT("BndEvt__Cube4_Blueprint_StaticMeshComponent_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void ACube4_Blueprint_C__pf2132744816::bpf__ExecuteUbergraph_Cube4_Blueprint__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 1);
	return; // KCST_GotoReturn
}
void ACube4_Blueprint_C__pf2132744816::bpf__BndEvt__Cube4_Blueprint_StaticMeshComponent_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_Cube4_Blueprint__pf_0(1);
}
PRAGMA_DISABLE_OPTIMIZATION
void ACube4_Blueprint_C__pf2132744816::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{113, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Engine/BasicShapes/Cube.Cube 
		{114, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Material /Engine/BasicShapes/BasicShapeMaterial.BasicShapeMaterial 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ACube4_Blueprint_C__pf2132744816::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{115, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.StaticMeshActor 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ACube4_Blueprint_C__pf2132744816
{
	FRegisterHelper__ACube4_Blueprint_C__pf2132744816()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/Cube4_Blueprint"), &ACube4_Blueprint_C__pf2132744816::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ACube4_Blueprint_C__pf2132744816 Instance;
};
FRegisterHelper__ACube4_Blueprint_C__pf2132744816 FRegisterHelper__ACube4_Blueprint_C__pf2132744816::Instance;
