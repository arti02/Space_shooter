...
AbpPickUpBase_C__pf407142385::AbpPickUpBase_C__pf407142385(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__Scene__pf = CreateDefaultSubobject<USceneComponent>(TEXT("Scene"));
	bpv__PickUpMesh__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("PickUpMesh"));
	...
	bpv__PickUpMesh__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__PickUpMesh__pf->AttachToComponent(bpv__Scene__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__2 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionChannel> >(&(bpv__PickUpMesh__pf->BodyInstance), FBodyInstance::__PPO__ObjectType() )));
	__Local__2 = ECollisionChannel::ECC_GameTraceChannel4;
	auto& __Local__3 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__PickUpMesh__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__4.AddUninitialized(12);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__4.GetData(), 12);
	...
	__Local__13.Channel = FName(TEXT("Enemy"));
	...
	__Local__15.Channel = FName(TEXT("EnemyProjectile"));
	__Local__15.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__16 = __Local__4[11];
	__Local__16.Channel = FName(TEXT("PickUp"));
	__Local__16.Response = ECollisionResponse::ECR_Ignore;
	bpv__PickUpMesh__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__PickUpMesh__pf), true, 0));
	...
	auto& __Local__17 = (*(AccessPrivateProperty<FVector >((bpv__Box__pf), UBoxComponent::__PPO__BoxExtent() )));
	__Local__17 = FVector(2000.000000, 2000.000000, 2000.000000);
	...
	__Local__18 = ECollisionChannel::ECC_GameTraceChannel4;
	...
	__Local__20.AddUninitialized(12);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__20.GetData(), 12);
	...
	bpv__RotatingMovement__pf->RotationRate = FRotator(0.000000, -180.000000, -180.000000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__RotatingMovement__pf), false, 0));
	bpv__bpPlayer__pf = nullptr;
	bpv__IncreasedSpeed__pf = 4000.000000f;
	bpv__DefaultxSpeed__pfT = -1000.000000f;
...
void AbpPickUpBase_C__pf407142385::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AbpPickUpBase_C__pf407142385::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__35 = NewObject<UComponentDelegateBinding>(InDynamicClass, UComponentDelegateBinding::StaticClass(), TEXT("ComponentDelegateBinding_1"), (EObjectFlags)0x00000000);
	...
	(((FBoolProperty*)__Local__36)->SetPropertyValue_InContainer((__Local__34), false, 0));
	__Local__35->ComponentDelegateBindings = TArray<FBlueprintComponentDelegateBinding> ();
	__Local__35->ComponentDelegateBindings.AddUninitialized(1);
	FBlueprintComponentDelegateBinding::StaticStruct()->InitializeStruct(__Local__35->ComponentDelegateBindings.GetData(), 1);
	auto& __Local__38 = __Local__35->ComponentDelegateBindings[0];
	__Local__38.ComponentPropertyName = FName(TEXT("Box"));
	__Local__38.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__38.FunctionNameToBind = FName(TEXT("BndEvt__bpPickUpBase_Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AbpPickUpBase_C__pf407142385::bpf__ExecuteUbergraph_bpPickUpBase__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 2:
			{
				bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(bpv__bpPlayer__pf);
		...
		case 3:
			{
				...
				if(::IsValid(bpv__bpPlayer__pf))
				{
					bpfv__CallFunc_K2_GetActorLocation_ReturnValue_1__pf = bpv__bpPlayer__pf->AActor::K2_GetActorLocation();
				}
				...
				bpfv__CallFunc_VLerp_ReturnValue__pf = UKismetMathLibrary::VLerp(((::IsValid(bpv__ProjectileMovement__pf)) ? (bpv__ProjectileMovement__pf->Velocity) : (__Local__39)), bpfv__CallFunc_Multiply_VectorFloat_ReturnValue__pf, 0.100000);
		...
		case 4:
			{
				bpfv__CallFunc_MakeVector_ReturnValue__pf = UKismetMathLibrary::MakeVector(0.000000, bpv__DefaultxSpeed__pfT, 0.000000);
				if(::IsValid(bpv__ProjectileMovement__pf))
				{
					bpv__ProjectileMovement__pf->Velocity = bpfv__CallFunc_MakeVector_ReturnValue__pf;
				}
				__CurrentState = -1;
				break;
			}
...
void AbpPickUpBase_C__pf407142385::bpf__ExecuteUbergraph_bpPickUpBase__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 6:
			{
				b0l__K2Node_DynamicCast_AsBp_Player__pf = Cast<AbpPlayer_C__pf1380491225>(b0l__K2Node_ComponentBoundEvent_OtherActor__pf);
				b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsBp_Player__pf != nullptr);;
		...
		case 7:
			{
				bpfv__CallFunc_IsValid_ReturnValue_1__pf = UKismetSystemLibrary::IsValid(bpv__bpPlayer__pf);
		...
		case 8:
			{
				bpv__bpPlayer__pf = b0l__K2Node_DynamicCast_AsBp_Player__pf;
				__CurrentState = -1;
				break;
			}
		default:
...
void AbpPickUpBase_C__pf407142385::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_bpPickUpBase__pf_0(1);
}
void AbpPickUpBase_C__pf407142385::bpf__BndEvt__bpPickUpBase_Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_bpPickUpBase__pf_1(5);
}
PRAGMA_DISABLE_OPTIMIZATION
void AbpPickUpBase_C__pf407142385::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AbpPickUpBase_C__pf407142385::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{79, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.RotatingMovementComponent 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AbpPickUpBase_C__pf407142385
{
	FRegisterHelper__AbpPickUpBase_C__pf407142385()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/PickUps/bpPickUpBase"), &AbpPickUpBase_C__pf407142385::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AbpPickUpBase_C__pf407142385 Instance;
};
FRegisterHelper__AbpPickUpBase_C__pf407142385 FRegisterHelper__AbpPickUpBase_C__pf407142385::Instance;
