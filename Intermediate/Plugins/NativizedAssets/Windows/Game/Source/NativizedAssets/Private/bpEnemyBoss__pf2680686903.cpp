...
AbpEnemyBoss_C__pf2680686903::AbpEnemyBoss_C__pf2680686903(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	__Local__0 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AbpEnemyBoss_C__pf2680686903::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	__Local__5 = FVector(0.000000, -170.000000, -640.000000);
	auto& __Local__6 = (*(AccessPrivateProperty<FRotator >((bpv__Bottom__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__6 = FRotator(0.000000, 0.000000, -10.000000);
	(((FBoolProperty*)__Local__1)->SetPropertyValue_InContainer((bpv__Bottom__pf), false, 0));
	bpv__MaxHealth__pf = 5000.000000f;
	bpv__FireRate__pf = 0.100000f;
	bpv__DropRate__pf = 1.000000f;
...
void AbpEnemyBoss_C__pf2680686903::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AbpEnemyBoss_C__pf2680686903::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void AbpEnemyBoss_C__pf2680686903::bpf__ExecuteUbergraph_bpEnemyBoss__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 1:
			{
				bpfv__CallFunc_SpawnSoundAtLocation_ReturnValue__pf = UGameplayStatics::SpawnSoundAtLocation(this, CastChecked<USoundBase>(CastChecked<UDynamicClass>(AbpEnemyBoss_C__pf2680686903::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed), FVector(0.000000,0.000000,0.000000), FRotator(0.000000,0.000000,0.000000), 1.000000, 1.000000, 0.000000, ((USoundAttenuation*)nullptr), ((USoundConcurrency*)nullptr), true);
				__CurrentState = -1;
				break;
			}
		case 2:
		...
		case 4:
			{
				UKismetSystemLibrary::SetFloatPropertyByName(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, FName(TEXT("Damage")), 5.000000);
			}
		case 5:
			{
				b1l__Temp_struct_Variable__pf = FVector(0.000000,-2000.000000,0.000000);
		...
		case 6:
			{
				b1l__Temp_struct_Variable_3__pf = FVector(1.000000,1.000000,1.000000);
		...
		case 9:
			{
				UKismetSystemLibrary::SetFloatPropertyByName(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1__pf, FName(TEXT("Damage")), 5.000000);
			}
		case 10:
			{
				b1l__Temp_struct_Variable_2__pf = FVector(0.000000,-2000.000000,0.000000);
		...
		case 11:
			{
				b1l__Temp_struct_Variable_1__pf = FVector(1.000000,1.000000,1.000000);
		...
		case 15:
			{
				UKismetSystemLibrary::Delay(this, bpv__FireRate__pf, FLatentActionInfo(2, 987483776, TEXT("ExecuteUbergraph_bpEnemyBoss_0"), this));
				__CurrentState = -1;
				break;
			}
		default:
...
void AbpEnemyBoss_C__pf2680686903::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b1l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_bpEnemyBoss__pf_0(13);
}
PRAGMA_DISABLE_OPTIMIZATION
void AbpEnemyBoss_C__pf2680686903::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AbpEnemyBoss_C__pf2680686903::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AbpEnemyBoss_C__pf2680686903
{
	FRegisterHelper__AbpEnemyBoss_C__pf2680686903()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/Enemies/bpEnemyBoss"), &AbpEnemyBoss_C__pf2680686903::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AbpEnemyBoss_C__pf2680686903 Instance;
};
FRegisterHelper__AbpEnemyBoss_C__pf2680686903 FRegisterHelper__AbpEnemyBoss_C__pf2680686903::Instance;
