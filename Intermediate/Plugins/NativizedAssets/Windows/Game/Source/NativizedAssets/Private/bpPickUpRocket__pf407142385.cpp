...
AbpPickUpRocket_C__pf407142385::AbpPickUpRocket_C__pf407142385(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	auto& __Local__0 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__PickUpMesh__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__0 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AbpPickUpRocket_C__pf407142385::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__PickUpMesh__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__PickUpMesh__pf->OverrideMaterials.Reserve(1);
	bpv__PickUpMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AbpPickUpRocket_C__pf407142385::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	bpv__PickUpMesh__pf->BodyInstance.LoadProfileData(false);
	...
	(((FBoolProperty*)__Local__1)->SetPropertyValue_InContainer((bpv__PickUpMesh__pf), true, 0));
...
void AbpPickUpRocket_C__pf407142385::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void AbpPickUpRocket_C__pf407142385::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(AbpPickUpBase_C__pf407142385::StaticClass());
	...
	__Local__8.ComponentPropertyName = FName(TEXT("PickUpMesh"));
	__Local__8.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__8.FunctionNameToBind = FName(TEXT("BndEvt__bpPickUpRocket_PickUpMesh_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AbpPickUpRocket_C__pf407142385::bpf__ExecuteUbergraph_bpPickUpRocket__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 2);
	// optimized KCST_UnconditionalGoto
	b1l__K2Node_DynamicCast_AsBp_Player__pf = Cast<AbpPlayer_C__pf1380491225>(b1l__K2Node_ComponentBoundEvent_OtherActor__pf);
	b1l__K2Node_DynamicCast_bSuccess__pf = (b1l__K2Node_DynamicCast_AsBp_Player__pf != nullptr);;
	if (!b1l__K2Node_DynamicCast_bSuccess__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	if(::IsValid(b1l__K2Node_DynamicCast_AsBp_Player__pf))
	{
		b1l__K2Node_DynamicCast_AsBp_Player__pf->bpv__bHasRockets__pf = true;
	}
	// optimized KCST_UnconditionalGoto
	K2_DestroyActor();
	return; // KCST_GotoReturn
}
void AbpPickUpRocket_C__pf407142385::bpf__BndEvt__bpPickUpRocket_PickUpMesh_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_bpPickUpRocket__pf_0(2);
}
PRAGMA_DISABLE_OPTIMIZATION
void AbpPickUpRocket_C__pf407142385::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AbpPickUpRocket_C__pf407142385::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{91, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Blueprints/PickUps/bpPickUpBase.bpPickUpBase_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AbpPickUpRocket_C__pf407142385
{
	FRegisterHelper__AbpPickUpRocket_C__pf407142385()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/PickUps/bpPickUpRocket"), &AbpPickUpRocket_C__pf407142385::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AbpPickUpRocket_C__pf407142385 Instance;
};
FRegisterHelper__AbpPickUpRocket_C__pf407142385 FRegisterHelper__AbpPickUpRocket_C__pf407142385::Instance;
