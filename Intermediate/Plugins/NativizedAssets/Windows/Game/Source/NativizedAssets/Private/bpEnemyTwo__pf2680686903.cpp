...
AbpEnemyTwo_C__pf2680686903::AbpEnemyTwo_C__pf2680686903(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__Top__pf = CreateDefaultSubobject<USceneComponent>(TEXT("Top"));
	bpv__Bottom__pf = CreateDefaultSubobject<USceneComponent>(TEXT("Bottom"));
	auto& __Local__0 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__EnemyMesh__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__0 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AbpEnemyTwo_C__pf2680686903::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__EnemyMesh__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__EnemyMesh__pf->OverrideMaterials.Reserve(1);
	bpv__EnemyMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AbpEnemyTwo_C__pf2680686903::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	bpv__EnemyMesh__pf->BodyInstance.LoadProfileData(false);
	...
	(((FBoolProperty*)__Local__1)->SetPropertyValue_InContainer((bpv__EnemyMesh__pf), true, 0));
	bpv__Top__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Top__pf->AttachToComponent(bpv__EnemyMesh__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__3 = (*(AccessPrivateProperty<FVector >((bpv__Top__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__3 = FVector(0.000000, -390.000000, 50.000000);
	auto& __Local__4 = (*(AccessPrivateProperty<FRotator >((bpv__Top__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__4 = FRotator(0.000000, 0.000000, 20.000000);
	(((FBoolProperty*)__Local__1)->SetPropertyValue_InContainer((bpv__Top__pf), false, 0));
	bpv__Bottom__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Bottom__pf->AttachToComponent(bpv__EnemyMesh__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__5 = (*(AccessPrivateProperty<FVector >((bpv__Bottom__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__5 = FVector(0.000000, -390.000000, -50.000000);
	auto& __Local__6 = (*(AccessPrivateProperty<FRotator >((bpv__Bottom__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__6 = FRotator(0.000000, 0.000000, -20.000000);
	(((FBoolProperty*)__Local__1)->SetPropertyValue_InContainer((bpv__Bottom__pf), false, 0));
	bpv__MaxHealth__pf = 150.000000f;
	bpv__FireRate__pf = 1.000000f;
	bpv__DropRate__pf = 0.700000f;
...
void AbpEnemyTwo_C__pf2680686903::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AbpEnemyTwo_C__pf2680686903::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void AbpEnemyTwo_C__pf2680686903::bpf__ExecuteUbergraph_bpEnemyTwo__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	AbpProjectileEnemy_C__pf4197612240* bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf{};
	AbpProjectileEnemy_C__pf4197612240* bpfv__CallFunc_FinishSpawningActor_ReturnValue_1__pf{};
	...
	do
	{
		...
		case 1:
			{
				UGameplayStatics::PlaySoundAtLocation(this, CastChecked<USoundBase>(CastChecked<UDynamicClass>(AbpEnemyTwo_C__pf2680686903::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed), FVector(0.000000,0.000000,0.000000), FRotator(0.000000,0.000000,0.000000), 1.000000, 1.000000, 0.000000, ((USoundAttenuation*)nullptr), ((USoundConcurrency*)nullptr), ((AActor*)nullptr));
				__CurrentState = -1;
				break;
			}
		case 2:
		...
		case 3:
			{
				if(::IsValid(bpv__Top__pf))
				{
					bpfv__CallFunc_K2_GetComponentToWorld_ReturnValue__pf = bpv__Top__pf->USceneComponent::K2_GetComponentToWorld();
				}
				bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, AbpProjectileEnemy_C__pf4197612240::StaticClass(), bpfv__CallFunc_K2_GetComponentToWorld_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::Undefined, ((AActor*)nullptr));
			}
		case 4:
			{
				UKismetSystemLibrary::SetFloatPropertyByName(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, FName(TEXT("Damage")), 20.000000);
			}
		case 5:
			{
				b1l__Temp_struct_Variable__pf = FVector(0.000000,-2200.000000,0.000000);
				UKismetSystemLibrary::SetVectorPropertyByName(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, FName(TEXT("Speed")), b1l__Temp_struct_Variable__pf);
			}
		case 6:
			{
				b1l__Temp_struct_Variable_3__pf = FVector(2.500000,1.000000,1.000000);
				UKismetSystemLibrary::SetVectorPropertyByName(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, FName(TEXT("Scale")), b1l__Temp_struct_Variable_3__pf);
			}
		case 7:
			{
				if(::IsValid(bpv__Top__pf))
				...
				bpfv__CallFunc_FinishSpawningActor_ReturnValue_1__pf = CastChecked<AbpProjectileEnemy_C__pf4197612240>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, bpfv__CallFunc_K2_GetComponentToWorld_ReturnValue__pf), ECastCheckedType::NullAllowed);
			}
		case 8:
			{
				if(::IsValid(bpv__Bottom__pf))
				{
					bpfv__CallFunc_K2_GetComponentToWorld_ReturnValue_1__pf = bpv__Bottom__pf->USceneComponent::K2_GetComponentToWorld();
				}
				bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, AbpProjectileEnemy_C__pf4197612240::StaticClass(), bpfv__CallFunc_K2_GetComponentToWorld_ReturnValue_1__pf, ESpawnActorCollisionHandlingMethod::Undefined, ((AActor*)nullptr));
			}
		case 9:
			{
				UKismetSystemLibrary::SetFloatPropertyByName(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1__pf, FName(TEXT("Damage")), 20.000000);
			}
		case 10:
			{
				b1l__Temp_struct_Variable_2__pf = FVector(0.000000,-2200.000000,0.000000);
				UKismetSystemLibrary::SetVectorPropertyByName(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1__pf, FName(TEXT("Speed")), b1l__Temp_struct_Variable_2__pf);
			}
		case 11:
			{
				b1l__Temp_struct_Variable_1__pf = FVector(2.500000,1.000000,1.000000);
				UKismetSystemLibrary::SetVectorPropertyByName(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1__pf, FName(TEXT("Scale")), b1l__Temp_struct_Variable_1__pf);
			}
		case 12:
			{
				if(::IsValid(bpv__Bottom__pf))
				...
				bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf = CastChecked<AbpProjectileEnemy_C__pf4197612240>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1__pf, bpfv__CallFunc_K2_GetComponentToWorld_ReturnValue_1__pf), ECastCheckedType::NullAllowed);
				__CurrentState = 1;
				break;
			}
		case 13:
		...
		case 15:
			{
				UKismetSystemLibrary::Delay(this, bpv__FireRate__pf, FLatentActionInfo(2, 2128260933, TEXT("ExecuteUbergraph_bpEnemyTwo_0"), this));
				__CurrentState = -1;
				break;
			}
		default:
...
void AbpEnemyTwo_C__pf2680686903::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b1l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_bpEnemyTwo__pf_0(13);
}
PRAGMA_DISABLE_OPTIMIZATION
void AbpEnemyTwo_C__pf2680686903::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AbpEnemyTwo_C__pf2680686903::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{95, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Blueprints/Enemies/BpEnemyBase.BpEnemyBase_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AbpEnemyTwo_C__pf2680686903
{
	FRegisterHelper__AbpEnemyTwo_C__pf2680686903()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/Enemies/bpEnemyTwo"), &AbpEnemyTwo_C__pf2680686903::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AbpEnemyTwo_C__pf2680686903 Instance;
};
FRegisterHelper__AbpEnemyTwo_C__pf2680686903 FRegisterHelper__AbpEnemyTwo_C__pf2680686903::Instance;
