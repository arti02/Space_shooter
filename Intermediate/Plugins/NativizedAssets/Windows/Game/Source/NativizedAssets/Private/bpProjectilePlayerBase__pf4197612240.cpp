...
AbpProjectilePlayerBase_C__pf4197612240::AbpProjectilePlayerBase_C__pf4197612240(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__ProjectileMesh__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("ProjectileMesh"));
	RootComponent = bpv__ProjectileMesh__pf;
	bpv__ProjectileMovement__pf = CreateDefaultSubobject<UProjectileMovementComponent>(TEXT("ProjectileMovement"));
	bpv__ProjectileMesh__pf->CreationMethod = EComponentCreationMethod::Native;
	auto& __Local__0 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__ProjectileMesh__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__0 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AbpProjectilePlayerBase_C__pf4197612240::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__ProjectileMesh__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__ProjectileMesh__pf->OverrideMaterials.Reserve(1);
	bpv__ProjectileMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AbpProjectilePlayerBase_C__pf4197612240::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	auto& __Local__1 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionChannel> >(&(bpv__ProjectileMesh__pf->BodyInstance), FBodyInstance::__PPO__ObjectType() )));
	__Local__1 = ECollisionChannel::ECC_GameTraceChannel2;
	auto& __Local__2 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__ProjectileMesh__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	(((FBoolProperty*)__Local__16)->SetPropertyValue_InContainer((bpv__ProjectileMesh__pf), true, 0));
	...
	bpv__ProjectileMovement__pf->Velocity = FVector(0.000000, 1.000000, 0.000000);
	(((FBoolProperty*)__Local__16)->SetPropertyValue_InContainer((bpv__ProjectileMovement__pf), false, 0));
...
void AbpProjectilePlayerBase_C__pf4197612240::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
	if(bpv__ProjectileMesh__pf)
	{
		bpv__ProjectileMesh__pf->CreationMethod = EComponentCreationMethod::Native;
	}
...
PRAGMA_DISABLE_OPTIMIZATION
void AbpProjectilePlayerBase_C__pf4197612240::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__23.ComponentPropertyName = FName(TEXT("ProjectileMesh"));
	__Local__23.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__23.FunctionNameToBind = FName(TEXT("BndEvt__BaseProjectile_ProjectileMesh_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AbpProjectilePlayerBase_C__pf4197612240::bpf__ExecuteUbergraph_bpProjectilePlayerBase__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 2:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess_1__pf = (b0l__K2Node_DynamicCast_AsBp_Enemy_Base__pf != nullptr);;
		...
		case 3:
			{
				bpfv__CallFunc_ApplyDamage_ReturnValue__pf = UGameplayStatics::ApplyDamage(b0l__K2Node_DynamicCast_AsBp_Enemy_Base__pf, bpv__Damage__pf, ((AController*)nullptr), ((AActor*)nullptr), ((UClass*)nullptr));
			}
		case 4:
			{
				bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf = AActor::K2_GetActorLocation();
				bpfv__CallFunc_SpawnEmitterAtLocation_ReturnValue__pf = UGameplayStatics::SpawnEmitterAtLocation(this, CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(AbpProjectilePlayerBase_C__pf4197612240::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed), bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf, FRotator(0.000000,0.000000,0.000000), FVector(1.000000,1.000000,1.000000), true, EPSCPoolMethod::None, true);
			}
		case 5:
			{
		...
		case 6:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsBp_Game_Mod__pf->bpf__CallCameShake__pf(CastChecked<UClass>(CastChecked<UDynamicClass>(AbpProjectilePlayerBase_C__pf4197612240::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed));
				}
			}
		case 7:
			{
...
void AbpProjectilePlayerBase_C__pf4197612240::bpf__BndEvt__BaseProjectile_ProjectileMesh_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_bpProjectilePlayerBase__pf_0(1);
}
void AbpProjectilePlayerBase_C__pf4197612240::bpf__UserConstructionScript__pf()
{
	if(::IsValid(bpv__ProjectileMovement__pf))
	{
		bpv__ProjectileMovement__pf->InitialSpeed = bpv__Speed__pf;
	}
	float  __Local__25 = 0.000000;
	if(::IsValid(bpv__ProjectileMovement__pf))
	{
		bpv__ProjectileMovement__pf->MaxSpeed = ((::IsValid(bpv__ProjectileMovement__pf)) ? (bpv__ProjectileMovement__pf->InitialSpeed) : (__Local__25));
	}
	AActor::SetActorScale3D(bpv__Scale__pf);
}
PRAGMA_DISABLE_OPTIMIZATION
void AbpProjectilePlayerBase_C__pf4197612240::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AbpProjectilePlayerBase_C__pf4197612240::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AbpProjectilePlayerBase_C__pf4197612240
{
	FRegisterHelper__AbpProjectilePlayerBase_C__pf4197612240()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/Projectiles/bpProjectilePlayerBase"), &AbpProjectilePlayerBase_C__pf4197612240::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AbpProjectilePlayerBase_C__pf4197612240 Instance;
};
FRegisterHelper__AbpProjectilePlayerBase_C__pf4197612240 FRegisterHelper__AbpProjectilePlayerBase_C__pf4197612240::Instance;
