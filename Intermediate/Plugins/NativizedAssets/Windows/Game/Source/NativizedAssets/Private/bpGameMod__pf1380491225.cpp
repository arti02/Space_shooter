...
AbpGameMod_C__pf1380491225::AbpGameMod_C__pf1380491225(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__DefaultSceneRoot__pf = CreateDefaultSubobject<USceneComponent>(TEXT("DefaultSceneRoot"));
	bpv__BGM__pf = CreateDefaultSubobject<UAudioComponent>(TEXT("BGM"));
	...
	bpv__BGM__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__BGM__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__BGM__pf->Sound = CastChecked<USoundBase>(CastChecked<UDynamicClass>(AbpGameMod_C__pf1380491225::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__BGM__pf), false, 0));
	bpv__bPlayerDead__pf = false;
	bpv__SpawnInerwal__pf = 0.000000f;
	bpv__LiveEnemies__pf = 0;
	bpv__MaxWaves__pf = 0;
	bpv__ActiveWave__pf = 0;
	bpv__Score__pf = 0;
	bpv__CoinsEarned__pf = 0;
	bpv__Coins__pf = 0;
	bpv__EnemySpownLocationMin__pf = FVector(4500.000000, 3400.000000, -1200.000000);
	bpv__EnemySpownLocationMax__pf = FVector(4500.000000, 5000.000000, 1200.000000);
	bpv__CoinxSavexName__pfTT = FString(TEXT(""));
	bpv__SavexSub__pfT = nullptr;
	bpv__GameOverMenuReference__pf = nullptr;
	DefaultPawnClass = AbpPlayer_C__pf1380491225::StaticClass();
...
void AbpGameMod_C__pf1380491225::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AbpGameMod_C__pf1380491225::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(AbpFloatingIsland_C__pf1380491225::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(UbpCoinSave_C__pf1380491225::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(AbpPlayer_C__pf1380491225::StaticClass());
	FConvertedBlueprintsDependencies::FillUsedAssetsInDynamicClass(InDynamicClass, &__StaticDependencies_DirectlyUsedAssets);
}
PRAGMA_ENABLE_OPTIMIZATION
void AbpGameMod_C__pf1380491225::bpf__ExecuteUbergraph_bpGameMod__pf_0(int32 bpp__EntryPoint__pf)
{
	UQuitGame_C__pf3053510930* bpfv__CallFunc_Create_ReturnValue__pf{};
	...
	do
	{
		...
		case 10:
			{
				bpfv__CallFunc_EqualEqual_StrStr_ReturnValue__pf = UKismetStringLibrary::EqualEqual_StrStr(bpfv__CallFunc_GetCurrentLevelName_ReturnValue__pf, FString(TEXT("Level1")));
		...
		case 11:
			{
				bpfv__CallFunc_Create_ReturnValue__pf = CastChecked<UQuitGame_C__pf3053510930>(UWidgetBlueprintLibrary::Create(this, UQuitGame_C__pf3053510930::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
			}
		case 12:
			{
				bpv__GameOverMenuReference__pf = bpfv__CallFunc_Create_ReturnValue__pf;
			}
		case 13:
			{
				if(::IsValid(bpv__GameOverMenuReference__pf))
				{
					bpv__GameOverMenuReference__pf->UUserWidget::AddToViewport(0);
				}
			}
		case 14:
			{
		...
		case 15:
			{
				bpfv__CallFunc_GetPlayerController_ReturnValue__pf = UGameplayStatics::GetPlayerController(this, 0);
				UWidgetBlueprintLibrary::SetInputMode_GameAndUIEx(bpfv__CallFunc_GetPlayerController_ReturnValue__pf, bpfv__CallFunc_Create_ReturnValue__pf, EMouseLockMode::DoNotLock, true);
				__CurrentState = -1;
				break;
			}
		case 16:
...
void AbpGameMod_C__pf1380491225::bpf__ExecuteUbergraph_bpGameMod__pf_1(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 3);
	// optimized KCST_UnconditionalGoto
	bpf__SaveCoins__pf();
	if(::IsValid(bpv__BGM__pf))
	{
		bpv__BGM__pf->Play(0.000000);
	}
	return; // KCST_GotoReturn
}
void AbpGameMod_C__pf1380491225::bpf__ExecuteUbergraph_bpGameMod__pf_2(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 6);
	// optimized KCST_UnconditionalGoto
	UGameplayStatics::PlayWorldCameraShake(this, b0l__K2Node_CustomEvent_ShakeType__pf, FVector(0.000000,0.000000,0.000000), -1.000000, 500.000000, 1.000000, false);
	return; // KCST_GotoReturn
}
void AbpGameMod_C__pf1380491225::bpf__ExecuteUbergraph_bpGameMod__pf_3(int32 bpp__EntryPoint__pf)
{
...
void AbpGameMod_C__pf1380491225::bpf__AllEnemiesDefetead__pf()
{
	bpf__ExecuteUbergraph_bpGameMod__pf_0(8);
}
void AbpGameMod_C__pf1380491225::bpf__CallCameShake__pf(UClass* bpp__ShakeType__pf)
{
	b0l__K2Node_CustomEvent_ShakeType__pf = bpp__ShakeType__pf;
	bpf__ExecuteUbergraph_bpGameMod__pf_2(6);
}
void AbpGameMod_C__pf1380491225::bpf__ReceiveEndPlay__pf(EEndPlayReason::Type bpp__EndPlayReason__pf)
{
	b0l__K2Node_Event_EndPlayReason__pf = bpp__EndPlayReason__pf;
	bpf__ExecuteUbergraph_bpGameMod__pf_1(3);
}
void AbpGameMod_C__pf1380491225::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_bpGameMod__pf_3(1);
}
void AbpGameMod_C__pf1380491225::bpf__AddCoin__pf()
{
	int32 bpfv__CallFunc_Add_IntInt_ReturnValue__pf{};
	bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(bpv__Coins__pf, 1);
	bpv__Coins__pf = bpfv__CallFunc_Add_IntInt_ReturnValue__pf;
}
void AbpGameMod_C__pf1380491225::bpf__LoadCoins__pf()
{
	FString bpfv__NewLocalVar_0__pf{};
	UbpCoinSave_C__pf1380491225* bpfv__K2Node_DynamicCast_AsBp_Coin_Save__pf{};
	...
	do
	{
		...
		case 1:
			{
				bpfv__NewLocalVar_0__pf = FString(TEXT("Coins"));
			}
		case 2:
			{
				bpfv__CallFunc_DoesSaveGameExist_ReturnValue__pf = UGameplayStatics::DoesSaveGameExist(bpv__CoinxSavexName__pfTT, 0);
			}
		case 3:
			{
		...
		case 4:
			{
				bpfv__CallFunc_LoadGameFromSlot_ReturnValue__pf = UGameplayStatics::LoadGameFromSlot(bpv__CoinxSavexName__pfTT, 0);
			}
		case 5:
			{
				bpv__SavexSub__pfT = bpfv__CallFunc_LoadGameFromSlot_ReturnValue__pf;
			}
		case 6:
			{
				bpfv__K2Node_DynamicCast_AsBp_Coin_Save__pf = Cast<UbpCoinSave_C__pf1380491225>(bpv__SavexSub__pfT);
				bpfv__K2Node_DynamicCast_bSuccess__pf = (bpfv__K2Node_DynamicCast_AsBp_Coin_Save__pf != nullptr);;
		...
		case 7:
			{
				int32  __Local__3 = 0;
				bpv__Coins__pf = ((::IsValid(bpfv__K2Node_DynamicCast_AsBp_Coin_Save__pf)) ? (bpfv__K2Node_DynamicCast_AsBp_Coin_Save__pf->bpv__CoinCount__pf) : (__Local__3));
			}
		case 8:
			{
				bpfv__CallFunc_SaveGameToSlot_ReturnValue__pf = UGameplayStatics::SaveGameToSlot(bpv__SavexSub__pfT, bpv__CoinxSavexName__pfTT, 0);
				__CurrentState = -1;
				break;
			}
		case 9:
...
void AbpGameMod_C__pf1380491225::bpf__SaveCoins__pf()
{
	UbpCoinSave_C__pf1380491225* bpfv__K2Node_DynamicCast_AsBp_Coin_Save__pf{};
	bool bpfv__K2Node_DynamicCast_bSuccess__pf{};
	bool bpfv__CallFunc_SaveGameToSlot_ReturnValue__pf{};
	UbpCoinSave_C__pf1380491225* bpfv__CallFunc_CreateSaveGameObject_ReturnValue__pf{};
	int32 __CurrentState = 1;
	do
	{
		switch( __CurrentState )
		...
		case 1:
			{
				bpfv__CallFunc_CreateSaveGameObject_ReturnValue__pf = CastChecked<UbpCoinSave_C__pf1380491225>(UGameplayStatics::CreateSaveGameObject(UbpCoinSave_C__pf1380491225::StaticClass()), ECastCheckedType::NullAllowed);
			}
		case 2:
			{
				bpv__SavexSub__pfT = bpfv__CallFunc_CreateSaveGameObject_ReturnValue__pf;
			}
		case 3:
			{
				bpfv__K2Node_DynamicCast_AsBp_Coin_Save__pf = Cast<UbpCoinSave_C__pf1380491225>(bpv__SavexSub__pfT);
		...
		case 4:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsBp_Coin_Save__pf))
				{
					bpfv__K2Node_DynamicCast_AsBp_Coin_Save__pf->bpv__CoinCount__pf = bpv__Coins__pf;
				}
			}
		case 5:
			{
...
void AbpGameMod_C__pf1380491225::bpf__AddScore__pf()
{
	int32 bpfv__CallFunc_Add_IntInt_ReturnValue__pf{};
	bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(bpv__Score__pf, 10);
	bpv__Score__pf = bpfv__CallFunc_Add_IntInt_ReturnValue__pf;
}
void AbpGameMod_C__pf1380491225::bpf__SpawnIsland__pf()
{
	...
	AbpFloatingIsland_C__pf1380491225* bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf{};
	bpfv__CallFunc_RandomFloatInRange_ReturnValue__pf = UKismetMathLibrary::RandomFloatInRange(-2500.000000, 2500.000000);
	bpfv__CallFunc_MakeVector_ReturnValue__pf = UKismetMathLibrary::MakeVector(21000.000000, 35000.000000, bpfv__CallFunc_RandomFloatInRange_ReturnValue__pf);
	...
	bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, AbpFloatingIsland_C__pf1380491225::StaticClass(), bpfv__CallFunc_MakeTransform_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::AlwaysSpawn, ((AActor*)nullptr));
	bpfv__CallFunc_RandomFloatInRange_ReturnValue__pf = UKismetMathLibrary::RandomFloatInRange(-2500.000000, 2500.000000);
	bpfv__CallFunc_MakeVector_ReturnValue__pf = UKismetMathLibrary::MakeVector(21000.000000, 35000.000000, bpfv__CallFunc_RandomFloatInRange_ReturnValue__pf);
	bpfv__CallFunc_MakeTransform_ReturnValue__pf = UKismetMathLibrary::MakeTransform(bpfv__CallFunc_MakeVector_ReturnValue__pf, FRotator(0.000000,0.000000,0.000000), FVector(1.000000,1.000000,1.000000));
	bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf = CastChecked<AbpFloatingIsland_C__pf1380491225>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, bpfv__CallFunc_MakeTransform_ReturnValue__pf), ECastCheckedType::NullAllowed);
}
PRAGMA_DISABLE_OPTIMIZATION
void AbpGameMod_C__pf1380491225::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AbpGameMod_C__pf1380491225::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{39, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.AudioComponent 
		{41, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Enum /Script/Engine.EEndPlayReason 
		...
		{35, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.GameModeBase 
		...
		{101, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Blueprints/Misc/bpFloatingIsland.bpFloatingIsland_C 
		{102, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Blueprints/Misc/bpCoinSave.bpCoinSave_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AbpGameMod_C__pf1380491225
{
	FRegisterHelper__AbpGameMod_C__pf1380491225()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/Misc/bpGameMod"), &AbpGameMod_C__pf1380491225::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AbpGameMod_C__pf1380491225 Instance;
};
FRegisterHelper__AbpGameMod_C__pf1380491225 FRegisterHelper__AbpGameMod_C__pf1380491225::Instance;
