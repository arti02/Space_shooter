...
AbpProjectileEnemy_C__pf4197612240::AbpProjectileEnemy_C__pf4197612240(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	__Local__0 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AbpProjectileEnemy_C__pf4197612240::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	auto& __Local__2 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionEnabled::Type> >(&(bpv__StaticMesh__pf->BodyInstance), FBodyInstance::__PPO__CollisionEnabled() )));
	__Local__2 = ECollisionEnabled::Type::QueryOnly;
	...
	__Local__4.AddUninitialized(11);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__4.GetData(), 11);
	...
	(((FBoolProperty*)__Local__16)->SetPropertyValue_InContainer((bpv__StaticMesh__pf), true, 0));
	bpv__RotatingMovement__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__RotatingMovement__pf->RotationRate = FRotator(180.000000, 0.000000, 0.000000);
	(((FBoolProperty*)__Local__16)->SetPropertyValue_InContainer((bpv__RotatingMovement__pf), false, 0));
	bpv__Damage__pf = 0.000000f;
	bpv__Speed__pf = FVector(0.000000, 0.000000, 0.000000);
	bpv__Scale__pf = FVector(0.000000, 0.000000, 0.000000);
...
void AbpProjectileEnemy_C__pf4197612240::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AbpProjectileEnemy_C__pf4197612240::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__23.ComponentPropertyName = FName(TEXT("StaticMesh"));
	__Local__23.DelegatePropertyName = FName(TEXT("OnComponentHit"));
	__Local__23.FunctionNameToBind = FName(TEXT("BndEvt__bpProjectileEnemy_StaticMesh_K2Node_ComponentBoundEvent_1_ComponentHitSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AbpProjectileEnemy_C__pf4197612240::bpf__ExecuteUbergraph_bpProjectileEnemy__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	bpfv__CallFunc_ApplyDamage_ReturnValue__pf = UGameplayStatics::ApplyDamage(b0l__K2Node_DynamicCast_AsBp_Player__pf, bpv__Damage__pf, ((AController*)nullptr), ((AActor*)nullptr), ((UClass*)nullptr));
	bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf = AActor::K2_GetActorLocation();
	bpfv__CallFunc_SpawnEmitterAtLocation_ReturnValue__pf = UGameplayStatics::SpawnEmitterAtLocation(this, CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(AbpProjectileEnemy_C__pf4197612240::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed), bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf, FRotator(0.000000,0.000000,0.000000), FVector(1.000000,1.000000,1.000000), true, EPSCPoolMethod::None, true);
	...
	b0l__K2Node_DynamicCast_bSuccess_1__pf = (b0l__K2Node_DynamicCast_AsBp_Game_Mod__pf != nullptr);;
	...
	{
		b0l__K2Node_DynamicCast_AsBp_Game_Mod__pf->bpf__CallCameShake__pf(CastChecked<UClass>(CastChecked<UDynamicClass>(AbpProjectileEnemy_C__pf4197612240::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
	}
	K2_DestroyActor();
	return; // KCST_GotoReturn
}
void AbpProjectileEnemy_C__pf4197612240::bpf__ExecuteUbergraph_bpProjectileEnemy__pf_1(int32 bpp__EntryPoint__pf)
{
	FVector bpfv__CallFunc_Multiply_VectorFloat_ReturnValue__pf(EForceInit::ForceInit);
	check(bpp__EntryPoint__pf == 8);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_Multiply_VectorFloat_ReturnValue__pf = UKismetMathLibrary::Multiply_VectorFloat(bpv__Speed__pf, b0l__K2Node_Event_DeltaSeconds__pf);
	AActor::K2_AddActorLocalOffset(bpfv__CallFunc_Multiply_VectorFloat_ReturnValue__pf, true, /*out*/ b0l__CallFunc_K2_AddActorLocalOffset_SweepHitResult__pf, false);
	return; // KCST_GotoReturn
}
void AbpProjectileEnemy_C__pf4197612240::bpf__BndEvt__bpProjectileEnemy_StaticMesh_K2Node_ComponentBoundEvent_1_ComponentHitSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__HitComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, FVector bpp__NormalImpulse__pf, FHitResult const& bpp__Hit__pf__const)
{
	...
	bpf__ExecuteUbergraph_bpProjectileEnemy__pf_0(1);
}
void AbpProjectileEnemy_C__pf4197612240::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_bpProjectileEnemy__pf_1(8);
}
void AbpProjectileEnemy_C__pf4197612240::bpf__UserConstructionScript__pf()
{
	AActor::SetActorScale3D(bpv__Scale__pf);
}
PRAGMA_DISABLE_OPTIMIZATION
void AbpProjectileEnemy_C__pf4197612240::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AbpProjectileEnemy_C__pf4197612240::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AbpProjectileEnemy_C__pf4197612240
{
	FRegisterHelper__AbpProjectileEnemy_C__pf4197612240()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/Projectiles/bpProjectileEnemy"), &AbpProjectileEnemy_C__pf4197612240::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AbpProjectileEnemy_C__pf4197612240 Instance;
};
FRegisterHelper__AbpProjectileEnemy_C__pf4197612240 FRegisterHelper__AbpProjectileEnemy_C__pf4197612240::Instance;
