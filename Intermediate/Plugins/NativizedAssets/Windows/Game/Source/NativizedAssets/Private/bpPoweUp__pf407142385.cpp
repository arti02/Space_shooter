...
AbpPoweUp_C__pf407142385::AbpPoweUp_C__pf407142385(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	auto& __Local__0 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__PickUpMesh__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__0 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AbpPoweUp_C__pf407142385::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
...
void AbpPoweUp_C__pf407142385::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void AbpPoweUp_C__pf407142385::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__8.FunctionNameToBind = FName(TEXT("BndEvt__bpPoweUp_PickUpMesh_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AbpPoweUp_C__pf407142385::bpf__ExecuteUbergraph_bpPoweUp__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	{
		b1l__K2Node_DynamicCast_AsBp_Player__pf->bpv__bHasPower__pf = true;
	}
	// optimized KCST_UnconditionalGoto
	K2_DestroyActor();
	return; // KCST_GotoReturn
}
void AbpPoweUp_C__pf407142385::bpf__BndEvt__bpPoweUp_PickUpMesh_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_bpPoweUp__pf_0(2);
}
PRAGMA_DISABLE_OPTIMIZATION
void AbpPoweUp_C__pf407142385::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AbpPoweUp_C__pf407142385::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AbpPoweUp_C__pf407142385
{
	FRegisterHelper__AbpPoweUp_C__pf407142385()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/PickUps/bpPoweUp"), &AbpPoweUp_C__pf407142385::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AbpPoweUp_C__pf407142385 Instance;
};
FRegisterHelper__AbpPoweUp_C__pf407142385 FRegisterHelper__AbpPoweUp_C__pf407142385::Instance;
