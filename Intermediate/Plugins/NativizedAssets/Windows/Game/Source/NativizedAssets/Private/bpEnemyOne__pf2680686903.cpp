...
AbpEnemyOne_C__pf2680686903::AbpEnemyOne_C__pf2680686903(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	__Local__0 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AbpEnemyOne_C__pf2680686903::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	bpv__ProjectileSpawn__pf->AttachToComponent(bpv__EnemyMesh__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__3 = (*(AccessPrivateProperty<FVector >((bpv__ProjectileSpawn__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__3 = FVector(0.000000, -350.000000, 0.000000);
	(((FBoolProperty*)__Local__1)->SetPropertyValue_InContainer((bpv__ProjectileSpawn__pf), false, 0));
	bpv__MaxHealth__pf = 100.000000f;
	bpv__FireRate__pf = 0.800000f;
	bpv__DropRate__pf = 0.300000f;
...
void AbpEnemyOne_C__pf2680686903::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AbpEnemyOne_C__pf2680686903::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void AbpEnemyOne_C__pf2680686903::bpf__ExecuteUbergraph_bpEnemyOne__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 1:
			{
				UGameplayStatics::PlaySoundAtLocation(this, CastChecked<USoundBase>(CastChecked<UDynamicClass>(AbpEnemyOne_C__pf2680686903::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed), FVector(0.000000,0.000000,0.000000), FRotator(0.000000,0.000000,0.000000), 1.000000, 1.000000, 0.000000, ((USoundAttenuation*)nullptr), ((USoundConcurrency*)nullptr), ((AActor*)nullptr));
				__CurrentState = -1;
				break;
			}
		case 2:
		...
		case 4:
			{
				UKismetSystemLibrary::SetFloatPropertyByName(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, FName(TEXT("Damage")), 10.000000);
			}
		case 5:
			{
				b1l__Temp_struct_Variable_1__pf = FVector(0.000000,-2000.000000,0.000000);
				UKismetSystemLibrary::SetVectorPropertyByName(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, FName(TEXT("Speed")), b1l__Temp_struct_Variable_1__pf);
			}
		case 6:
			{
				b1l__Temp_struct_Variable__pf = FVector(2.000000,2.000000,2.000000);
				UKismetSystemLibrary::SetVectorPropertyByName(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, FName(TEXT("Scale")), b1l__Temp_struct_Variable__pf);
			}
		case 7:
			{
				if(::IsValid(bpv__ProjectileSpawn__pf))
				...
				bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf = CastChecked<AbpProjectileEnemy_C__pf4197612240>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, bpfv__CallFunc_K2_GetComponentToWorld_ReturnValue__pf), ECastCheckedType::NullAllowed);
				__CurrentState = 1;
				break;
			}
		case 8:
		...
		case 10:
			{
				UKismetSystemLibrary::Delay(this, bpv__FireRate__pf, FLatentActionInfo(2, 486300829, TEXT("ExecuteUbergraph_bpEnemyOne_0"), this));
				__CurrentState = -1;
				break;
			}
		default:
...
void AbpEnemyOne_C__pf2680686903::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b1l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_bpEnemyOne__pf_0(8);
}
PRAGMA_DISABLE_OPTIMIZATION
void AbpEnemyOne_C__pf2680686903::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AbpEnemyOne_C__pf2680686903::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AbpEnemyOne_C__pf2680686903
{
	FRegisterHelper__AbpEnemyOne_C__pf2680686903()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/Enemies/bpEnemyOne"), &AbpEnemyOne_C__pf2680686903::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AbpEnemyOne_C__pf2680686903 Instance;
};
FRegisterHelper__AbpEnemyOne_C__pf2680686903 FRegisterHelper__AbpEnemyOne_C__pf2680686903::Instance;
